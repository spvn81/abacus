...
use app\modules\admin\models\search\SchoolsSearch;
...
class SchoolsController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'add-classes', 'add-student-details'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    public function actionView($id)
    {
        ...
        $providerClasses = new \yii\data\ArrayDataProvider([
            'allModels' => $model->classes,
        ]);
    ...
    * @return mixed
    */
    public function actionAddClasses()
    {
        if (Yii::$app->request->isAjax) {
            $row = Yii::$app->request->post('Classes');
            if (!empty($row)) {
                $row = array_values($row);
            }
            if((Yii::$app->request->post('isNewRecord') && Yii::$app->request->post('_action') == 'load' && empty($row)) || Yii::$app->request->post('_action') == 'add')
                $row[] = [];
            return $this->renderAjax('_formClasses', ['row' => $row]);
        } else {
            throw new NotFoundHttpException(Yii::t('app', 'The requested page does not exist.'));
        }
    }
